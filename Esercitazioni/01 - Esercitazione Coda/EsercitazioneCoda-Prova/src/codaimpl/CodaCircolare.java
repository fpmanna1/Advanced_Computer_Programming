...
public class CodaCircolare implements Coda {
	...
	public void inserisci( int i ){
		data[ tail%size ] =i; // gestione circolare
		...
		tail=tail+1; // aggiornamento del prossimo elemento libero
	}
	
	
	//estrae un elemento 
	public int preleva (){
		int x = data[ head%size ]; // valore letto con aggiornamento circolare (%size)
		...
		head=head+1; // incremento la testa
		return x;
	}
